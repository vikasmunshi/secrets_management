...
ADD https://raw.githubusercontent.com/vikasmunshi/secrets_management/master/sample.json /etc/cert_policy.json
# command to generate rsa private key and certificate signing request, use RUN only for testing
RUN python3 -m cloak csr /etc/cert_policy.json
